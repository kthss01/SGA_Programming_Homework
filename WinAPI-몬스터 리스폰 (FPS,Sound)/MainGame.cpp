...
HRESULT MainGame::Init()
{
	...
	SOUND->Init();
	SOUND->AddSound("bgm", "sounds/pokemon_bgm.mp3", true, true);
	SOUND->AddSound("die", "sounds/pokemon_die.wav", false, false);
	SOUND->AddSound("fire", "sounds/pokemon_fire.wav", false, false);
