...
public:
	...
	// 프레임 가로 세로 크기 Get Set
	inline int GetFrameWidth() { return m_imageInfo->frameWidth; }
	inline int GetFrameHeight() { return m_imageInfo->frameHeight; }
	inline void SetFrameWidth(int frameWidth) { m_imageInfo->frameWidth = frameWidth; }
	inline void SetFrameHeight(int frameHeight) { m_imageInfo->frameHeight = frameHeight; }
	// 맥스 프레임 x, y, Get
