...
{
	vertice[0].position = Vector2(-WINSIZE_X, WINSIZE_Y / 2);
	vertice[1].position = Vector2(-WINSIZE_X, -WINSIZE_Y / 2);
	vertice[2].position = Vector2(WINSIZE_X, -WINSIZE_Y / 2);
	vertice[3].position = Vector2(WINSIZE_X, WINSIZE_Y / 2);
